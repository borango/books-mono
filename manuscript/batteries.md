...
Compared to energy production, which is absolutely limited by space, I find sizing the batteries not so difficult. Let us assume that space for solar panels limits your daily production at 10 kWh (that would be a lot). Batteries to store 10 kWh weigh less than 100 kg. So you can easily size your batteries rather too large than too small, and enjoy plenty of [extra capacity](#pp03) most of the time.

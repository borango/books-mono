...
% BoGo fixing 'Undefined control sequence' in pandoc on PI OS
% see also https://stackoverflow.com/questions/69893867/undefined-control-sequence-when-using-tufte-latex-package
...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    ...
    \vspace{0.5cm}
    \ifx\@subtitle\empty\else{\Large\@subtitle\par}\fi
    \vspace{1cm}
    {\large\@author\par}
    \vspace{0.5cm}
    {\large\@date\par}
...
% END BoGo customization

\begin{document}

% BoGo customization: full-page cover image

\newpage
\thispagestyle{empty}
\begin{titlepage}
    \vspace*{\fill}
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{resources/title_page.png}
    \vspace*{\fill}
\end{titlepage}
